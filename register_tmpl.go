...
<head>
    ...
    <style>
        ...
        .register-container { max-width: 400px; margin: 100px auto; }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <span class="navbar-text">
                <a href="/login" class="text-white text-decoration-none">已有账号？点击登录</a>
            </span>
        </div>
    </div>
</nav>
        ...
        <div class="card-body p-4">
            ...
            <form action="/register" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="user_name" placeholder="请输入昵称" required>
                </div>
                <div class="mb-3">
                    <label class="form-label text-muted">邮箱</label>
                    <input type="email" class="form-control" name="email" placeholder="example@stu.edu.cn" required>
                </div>
                <div class="mb-4">
                    <label class="form-label text-muted">密码</label>
                    <input type="password" class="form-control" name="password" placeholder="设置密码" required>
                </div>
                <button type="submit" class="btn btn-primary mb-3">立 即 注 册</button>
            </form>
        </div>
    </div>
</div>
...
os.WriteFile("templates/register.html", []byte(html), 0644)
}
